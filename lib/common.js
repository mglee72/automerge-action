...
function createConfig(env = {}) {
  ...
  function splitOrDefault(str, defaultValue) {
  ...
  const mergeRemoveLabels = splitOrDefault(env.MERGE_REMOVE_LABELS, "");
  const mergeRequireStatuses = splitOrDefault(env.MERGE_REQUIRE_STATUSES, "");
